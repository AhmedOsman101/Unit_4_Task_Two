            ...
            <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                ...
                <div class="flex mt-6 items-center pb-5 border-b-2 border-gray-800 mb-5">
                    <div class="flex items-center">
                        <span class="mr-3">Join As</span>
                        <div class="relative">
                            <select
                                class="rounded border appearance-none bg-gray-800 border-gray-800 py-2 focus:outline-none focus:border-red-500 text-base pl-3 pr-10">
                                <option>Team</option>
...
<section class="text-white body-font overflow-hidden bg-gray-900">
        ...
        <div class="lg:w-4/5 mx-auto flex flex-wrap">
            ...
            <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                ...
                <div class="flex flex-col gap-4">
                    ...
                    <div id="individual-selection" class="flex" style="display: none;">
                        <button
                            class="flex text-white bg-red-500 border-0 py-2 px-6 focus:outline-none hover:bg-red-600 rounded">Join
    ...
    <script defer>
        document.getElementById("join-select").addEventListener("change", function() {
            ...
            if (selection === "team") {
                ...
                document.getElementById("individual-selection").style.display = "flex";
